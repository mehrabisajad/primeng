...
export class PrimeNGConfig {
    ...
    public translation: Translation = {
        ...
        jalaliMonthNames: ['Farvardin','Ordibehesht','Khordād','Tir','Mordād','Shahrivar','Mehr','Abān','Azar','Dey','Bahman','Esfand'],
        monthNamesShort: ['Jan', 'Feb', 'Mar', 'Apr', 'May', 'Jun', 'Jul', 'Aug', 'Sep', 'Oct', 'Nov', 'Dec'],
        jalaliMonthNamesShort: ['Far', 'Ord', 'Kho', 'Tir', 'Mor', 'Sha', 'Meh', 'Abā', 'Aza', 'Dey', 'Bah', 'Esf'],
        ...
        dateFormat: 'mm/dd/yy',
        firstDayOfWeek: 0,
        jalaliFirstDayOfWeek: 6,
        today: 'Today',
        gregorianCalenderName: 'Gregorian',
        jalaliCalenderName: 'Jalali',
        weekHeader: 'Wk',
        weak: 'Weak',
        medium: 'Medium',
        strong: 'Strong',
