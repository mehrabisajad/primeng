...
import { Confirmation, ConfirmationService, OverlayService, PrimeNGConfig, PrimeTemplate, SharedModule, TranslationKeys } from 'avan-primeng/api';
...
export class ConfirmPopup implements AfterContentInit, OnDestroy {
    ...
    align() {
        ...
        if (DomHandler.isLTR(this.container)) {
            ...
            (this.container as HTMLDivElement).style.setProperty('--overlayArrowRight', `${arrowRight}px`);
        }
